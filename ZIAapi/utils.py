...
def check_response(response: requests.Response, comment: str, expected_code=200):
    ...
    Args:
        response (requests.Response): The response object.
        comment (str): The string to be printed. Message will display like this: \"Request for <comment> successful/unsuccessful.\"
...
def clean_args(args: dict, exemption=[]) -> dict:
